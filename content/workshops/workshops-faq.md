...
The contact person for the workshop webpage can be designated by the workshop organiser. The person listed should be knowledgeable about the workshop so they can answer questions regarding the workshop such as attendance policy, waitlist, location, installation, etc. You can have multiple persons listed as the contact person if needed.
{{< /accordion >}}
...
Hosting organisations are welcome to compensate Instructors directly, as The Carpentries is unable to process payments on their behalf. If you’d like to support Instructor development more broadly, you’re also invited to make a targeted [donation]({{< param donate_url >}}) to The Carpentries.
